...
.text	# Define prrogram instructions
main:	# Label to define the main program
	...
	syscall		# Print greeting. The print is indicated by $v0 having a value of 4 and the string to print is stored at the address in $a0
